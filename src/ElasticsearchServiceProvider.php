...
namespace Falconsw\Elasticsearch;

use Falconsw\Elasticsearch\Commands\ReindexCommand;
use Elasticsearch\ClientBuilder as ElasticBuilder;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Support\ServiceProvider;
use Laravel\Scout\EngineManager;
use Illuminate\Support\Str;
use Falconsw\Elasticsearch\Commands\ListIndicesCommand;
use Falconsw\Elasticsearch\Commands\CreateIndexCommand;
use Falconsw\Elasticsearch\Commands\DropIndexCommand;
use Falconsw\Elasticsearch\Commands\UpdateIndexCommand;

/**
 * Class ElasticsearchServiceProvider
 * @package Falconsw\Elasticsearch
 */
